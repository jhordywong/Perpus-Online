                    ...
                    <div class="card-body">
                      <h4 class="card-title">Tambah Anggota baru</h4>
                        ...
                        <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }} " style="margin-bottom: 20px;">
                            <label for="user_id" class="col-md-4 control-label">Anggota Untuk User Anda Sendiri</label>
                            <div class="col-md-6">
                            <select class="form-control" name="user_id" required="">
                                <option value="">(Pilih User Anda)</option>
                        ...
                        <a href="/register" class="btn btn-light pull-right">Back</a>
                    </div>
                  </div>
                </div>
              </div>
